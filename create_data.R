...
plot(de_median_gen$HV, ylim = c(min(my.data$HV)-0.2,max(my.data$HV)+0.2))
lines(rad_median_gen$HV, col = "blue")#
lines(dra_median_gen$HV, col = "brown")
lines(gra_median_gen$HV, col = "black")
lines (norm_median_gen$HV, col = "green")
lines(random_median_gen$HV, col = "red")#



plot(de_median_gen$IGD, ylim = c(min(my.data$IGD)-0.2,max(my.data$IGD)+0.2))
lines(rad_median_gen$IGD, col = "blue")#
lines(dra_median_gen$IGD, col = "brown")
lines(gra_median_gen$IGD, col = "black")
lines (norm_median_gen$IGD, col = "green")
lines(random_median_gen$IGD, col = "red")#

# save(my.data, file = "results.RData")
# names(my.data)[3] <- "algorithm"
# create_graphs(my.data, fun.names)
# create_graphs_log(my.data, fun.names)i
