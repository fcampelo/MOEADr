...
vignette: > 
  %\VignetteIndexEntry{Fine tuning MOEA/D configurations using MOEADr and irace} 
...
Ten unconstrained test problems from the CEC2009 competition^[Functions UF1 to UF10 ([http://dces.essex.ac.uk/staff/qzhang/moeacompetition09.htm](http://dces.essex.ac.uk/staff/qzhang/moeacompetition09.htm)), using the standard implementation available in the **smoof** package.] are used, with dimensions ranging from 20 to 60. Dimensions 30, 40 and 50 were 
