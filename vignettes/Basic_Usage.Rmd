...
The *moead()* function returns a list object of class _moeadoutput_, containing the final solution set, objective values for each solution, and other information about the optimization process.
