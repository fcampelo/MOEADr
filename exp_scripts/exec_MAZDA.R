...
for (i in 1:n_runs) {
  print("iter")
  dir.name <- paste0("~/gecco2021/mazda_random_iter_", i, "/")
  ...
  dir.name <- paste0("~/gecco2021/mazda_random_updates_iter_", i, "/")
  if (!dir.exists(dir.name))
    dir.create(dir.name)
  ...
  dir.name <- paste0("~/gecco2021/mazda_moead.updates_iter_", i, "/")
  if (!dir.exists(dir.name))
    dir.create(dir.name)
